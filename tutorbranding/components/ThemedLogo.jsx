  ...
  return (
    <>
      ...
      <a href={`${BASE_URL}/dashboard`} title="Open edX" className="logo">
        <img className="logo-image" src={`${BASE_URL}/static/inovatec/images/logo.png`} alt="Open edX" />
        <img className="logo-image logo-white" src={`${BASE_URL}/static/inovatec/images/logo-white.png`} alt="Open edX" />
      </a>
    </>
  );
};
